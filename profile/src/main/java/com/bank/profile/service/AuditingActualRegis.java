...
/**
 * Этот класс представляет AuditingActualRegis прослушевает класс ActualRegistrationEntity .
 * <p>
 ...
 * now - переменная для сохранения времени  при добавлении
 *
...
@Component
@Transactional
public class AuditingActualRegis {
